    ...
    <>
      ...
      <div className="flex justify-between items-center min-h-screen bg-[#f3faf7]  max-md:flex-wrap rtl">
        <div className="w-1/2 p-10  ml-5 max-md:ml-0 max-md:order-2 py-20 bg-white shadow-lg rounded-lg text-right max-md:w-full">
          ...
          <form className="min-w-full text-right" onSubmit={(e) => {e.preventDefault()}}>


            <Input lable="البريد الالكتروني"  classes="w-full mb-10 text-right" name="email" onChange={(e)=>handleChange(e)} />
            <br />

            <Input lable="كلمه السر" classes="w-full " name="password" onChange={(e)=>handleChange(e)} />

            <br />
            <button type="button"  className="cursor-pointer  bg-[#facc15] text-white mt-5 border-[#facc15] border-2 hover:bg-white hover:text-[#facc15] duration-150  px-8 py-3 rounded-md">تسجيل الدخول</button>
          </form>
